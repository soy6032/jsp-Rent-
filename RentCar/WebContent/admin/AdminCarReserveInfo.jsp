	...
	<body>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="./CarListDel.jsp?no=<%=bean.getNo()%>" class="btn btn-secondary col-sm-3">차량 삭제</a>
				<a href="./AdminMain.jsp?center=CarListUpdateForm.jsp?no=<%=bean.getNo()%>" class="btn btn-secondary col-sm-3">차량 수정</a>
				<a href="AdminMain.jsp?center=AdminCarAllList.jsp" class="btn col-sm-6" style="margin-top: 10px;">상품 목록 &raquo;</a>
				</p>
			</div>
		</div>
		</form>
